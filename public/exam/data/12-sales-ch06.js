...
addChapter(
  { id: 'sales-ch06', subject: 'sales', no: 6, title: 'บุคลิกภาพและ Soft Skills ของนักขาย', en: 'Personality & Soft Skills' },
  {
    mc: [
      ...
      {
        id: 'm6-05',
        q: 'ข้อใด "ไม่ใช่" องค์ประกอบของ Professional Image ตามบทเรียน',
        choices: [
          'การแต่งกายเหมาะสมกับบริบท (B2B vs B2C)',
          'ภาษากาย: ตั้งตรง สบตา จับมือมั่นคง',
          'Digital Presence: โปรไฟล์ LinkedIn และลายเซ็นอีเมล',
      ...
      {
        id: 'm6-12',
        q: 'ข้อใดอธิบายความแตกต่างระหว่าง Passive Listening กับ Active Listening ได้ถูกต้อง',
        choices: [
        ...
        answer: 1,
        explain: 'Passive Listening = ได้ยิน แค่รับเสียงเข้าหูแต่ไม่ประมวลผล / Active Listening = เข้าใจ + ตีความ + ตอบสนอง ฟังอย่างมีเป้าหมาย',
        ref: 'บทที่ 6 — Active Listening'
      },
      {
        id: 'm6-13',
        q: 'ตัว "S" ในเทคนิค SOLER หมายถึงอะไร',
        choices: [
      ...
      {
        id: 'm6-15',
        q: 'เทคนิค Paraphrasing เช่น "ที่คุณหมายความว่า... ใช่ไหมครับ?" มีประโยชน์อย่างไร',
        choices: [
        ...
        answer: 0,
        explain: 'Paraphrasing ช่วยยืนยันความเข้าใจและทำให้ลูกค้ารู้สึกว่าถูกรับฟัง — เป็นเครื่องมือที่ทรงพลังที่สุดในกล่องเครื่องมือของนักขาย',
        ref: 'บทที่ 6 — Active Listening'
      },
      {
        id: 'm6-16',
      ...
      {
        id: 'm6-18',
        q: 'Empathy ระดับสูงสุด (ระดับที่ 3) ในการขายคือข้อใด',
        choices: [
      ...
      {
        id: 'm6-21',
        q: 'Power Pose ของ Amy Cuddy (ยืนท่า Wonder Woman 2 นาทีก่อนนำเสนอ) ให้ผลลัพธ์อย่างไร',
        choices: [
        ...
        answer: 0,
        explain: 'Power Pose 2 นาที: ลด Cortisol (ฮอร์โมนความเครียด) 25% และเพิ่ม Testosterone 20%',
        ref: 'บทที่ 6 — Confidence'
      },
      {
        id: 'm6-22',
        q: 'ข้อใด "ไม่ใช่" 1 ใน 4 วิธีสร้าง Confidence ในการขาย',
        choices: [
          'รู้จักสินค้าลึกซึ้ง',
      ...
      {
        id: 'm6-23',
        q: 'Growth Mindset ตามกรอบของ Carol Dweck ต่างจาก Fixed Mindset อย่างไร',
        choices: [
        ...
        answer: 1,
        explain: 'Fixed Mindset: "ฉันไม่เก่งการขาย" หยุดพัฒนาเพราะเชื่อว่าความสามารถตายตัว / Growth Mindset: "ฉันยังไม่เก่ง แต่กำลังพัฒนา" มองทุกอุปสรรคเป็นโอกาสเรียนรู้',
      ...
      {
        id: 'm6-25',
        q: 'BATNA ย่อมาจากอะไร และมีความสำคัญอย่างไร',
        choices: [
      ...
      {
        id: 'm6-26',
        q: 'เทคนิคการเจรจา "Anchoring" หมายถึงอะไร',
        choices: [
      ...
      {
        id: 'm6-27',
        q: 'เทคนิค "Bundling" ในการเจรจาคืออะไร',
        choices: [
          'ลดราคาลงทันทีเมื่อถูกต่อรอง เพื่อรักษาลูกค้าไว้ไม่ให้ไปหาคู่แข่ง',
          'แทนที่จะลดราคา ให้เพิ่มคุณค่า เช่น บริการหลังการขาย หรือการรับประกัน',
          'ขายสินค้าหลายชิ้นพร้อมกันในราคาต้นทุนเพื่อระบายสต๊อกที่ค้างอยู่',
          'เสนอราคาแรกก่อนคู่แข่งเสมอ เพื่อให้ตัวเลขของเราเป็นจุดอ้างอิง',
          'แบ่งชำระเป็นงวดเพื่อลดภาระของลูกค้าโดยยังคงราคาเต็มไว้เท่าเดิม'
        ],
        answer: 1,
      ...
      {
        id: 'm6-29',
        q: 'ทำไมการขายระยะยาวจึงต้องการ Win-Win ไม่ใช่ Win-Lose',
        choices: [
          'เพราะกฎหมายกำหนด',
        ...
        answer: 1,
        explain: 'การขายระยะยาวต้องการ Win-Win — ลูกค้าที่รู้สึกแพ้จะไม่กลับมาซื้ออีก และยังบอกต่อแง่ลบได้',
        ref: 'บทที่ 6 — Negotiation'
      },
      {
        id: 'm6-30',
      ...
      {
        id: 'm6-33',
        q: 'กระบวนการ Problem Solving ในการขาย 4 ขั้นตอนคือข้อใด',
        choices: [
        ...
        answer: 0,
        explain: 'Define (ระบุปัญหาที่แท้จริง) → Diagnose (วิเคราะห์ Root Cause) → Design (ออกแบบโซลูชัน) → Deliver (นำเสนอและติดตามผล)',
      ...
      },
      {
        ...
        choices: [
          'จาก "ที่ปรึกษา" กลับไปเป็น "คนขายของ" ที่เน้นปิดยอดให้ได้ตามเป้า',
          'จาก "ที่ปรึกษา" เป็น "ผู้เชี่ยวชาญด้านเทคนิค" ที่ตอบสเปคสินค้าได้ทุกข้อ',
          'จาก "ขายของ" เป็น "ที่ปรึกษา" ที่ช่วยแก้ปัญหาธุรกิจ เปลี่ยน Transaction เป็น Partnership',
          'จาก "นักขาย" เป็น "นักการตลาด" ที่ดูแลแคมเปญและสื่อสารกับตลาดทั้งหมด',
          'จาก "พนักงานประจำ" เป็น "ฟรีแลนซ์" ที่รับค่าตอบแทนตามยอดขายที่ทำได้'
        ],
        answer: 2,
      ...
      {
        id: 'm6-36',
        q: 'กฎ 80/20 (Pareto) ในการบริหารเวลาของนักขายหมายความว่าอย่างไร',
        choices: [
          'ทำงาน 80% พักผ่อน 20%',
      ...
      {
        id: 'm6-37',
        q: 'ใน Sales Activity Matrix กิจกรรม "Prospecting และพัฒนาทักษะ" อยู่ในช่องใด และควรจัดการอย่างไร',
        choices: [
        ...
        answer: 1,
        explain: 'Prospecting และการพัฒนาทักษะอยู่ในช่อง Not Urgent + Important → ต้อง "วางแผนทำ"',
        ref: 'บทที่ 6 — Time Management'
      },
      {
        id: 'm6-38',
      ...
      },
      {
        ...
        choices: [
          'Cold Call — โทรหาลูกค้า B2B ที่ยังไม่รู้จักแบรนด์',
          'Follow-up — นัดพบและติดตามดีลที่อยู่ใน Pipeline',
          'Prospecting — ค้นหารายชื่อลูกค้าใหม่จากหลายแหล่ง',
          'Admin — อัปเดต CRM บันทึกรายงาน วางแผนวันถัดไป',
          'Presentation — เตรียมและซ้อมนำเสนอให้ลูกค้ารายใหญ่'
        ],
        answer: 3,
      ...
      {
        id: 'm6-41',
        q: 'องค์ประกอบ "Self-Regulation" ของ EQ ในการขายหมายถึงอะไร',
        choices: [
      ...
      {
        id: 'm6-44',
        q: 'ทักษะในชั้น "Interaction" ของ Soft Skills ประกอบด้วยข้อใด',
        choices: [
          'Communication, Active Listening, Empathy, EQ',
          'Professional Image, Confidence, Growth Mindset',
          'Negotiation, Critical Thinking, Problem Solving, Time Management',
      ...
      {
        id: 'm6-47',
        q: 'ในยุค Digital Selling ทักษะใดที่บทเรียนระบุว่า AI ยังแทนที่มนุษย์ไม่ได้',
        choices: [
        ...
        answer: 1,
        explain: 'AI ช่วย Prospecting และ Data Analysis ได้ แต่ Empathy, EQ และ Negotiation ยังต้องการมนุษย์ — ใช้ AI เป็นเครื่องมือ ไม่ใช่ทดแทน',
        ref: 'บทที่ 6 — Soft Skills ในยุค Digital Selling'
      },
      {
        id: 'm6-48',
      ...
      {
        id: 'm6-50',
        q: 'ทำไมการ "ลดราคาทันทีที่ถูกต่อ" จึงเป็นข้อผิดพลาด',
        choices: [
          'เพราะผิดนโยบายบริษัททุกแห่ง และอาจถูกตรวจสอบย้อนหลังจากฝ่ายบัญชี',
          'เพราะแสดงว่าราคาเดิมไม่สมเหตุสมผล ควรใช้ Bundling หรือ Value-based Argument แทน',
          'เพราะลูกค้าจะไม่เชื่อว่าสินค้ามีคุณภาพจริงเมื่อเห็นว่าลดราคาได้ง่ายขนาดนั้น',
          'เพราะทำให้เสียเวลาในการเจรจามากขึ้น เนื่องจากลูกค้าจะขอต่อรองซ้ำอีกรอบ',
          'เพราะขัดกับหลัก Win-Win ในการเจรจาที่ทั้งสองฝ่ายต้องได้ประโยชน์เท่ากัน'
        ],
        answer: 1,
      ...
      {
        id: 'm6-52',
        q: 'ในแผนพัฒนา Soft Skills ระยะ 30 วันแรก (Build Awareness) ควรทำสิ่งใด',
        choices: [
        ...
        ref: 'บทที่ 6 — แผนพัฒนา Soft Skills'
      }
    ],
    ...
    fill: [
      {
        id: 'f6-01',
        q: 'ตาม Harvard Business Review (2023) ความสำเร็จในอาชีพ ____ % มาจาก Soft Skills',
        accept: ['85', '85%'],
        hint: 'ตัวเลข 2 หลัก',
        explain: '85% ของความสำเร็จในอาชีพมาจาก Soft Skills',
        ref: 'บทที่ 6 — Soft Skills'
      },
      {
        id: 'f6-02',
        q: 'กฎ 7-38-55 ของ Mehrabian ระบุว่า ____ มีสัดส่วนมากที่สุดถึง 55% ในการสื่อสาร',
        accept: ['ภาษากาย', 'Body Language', 'บอดี้แลงเกวจ'],
        hint: 'คำไทย หมายถึงการแสดงออกทางร่างกาย',
        explain: 'ภาษากาย 55% / น้ำเสียง 38% / คำพูด 7%',
        ref: 'บทที่ 6 — Communication'
      },
      {
        id: 'f6-03',
        q: 'เทคนิคการฟังอย่างตั้งใจที่ประกอบด้วย Squarely face, Open posture, Lean in, Eye contact และ Relax เรียกว่าเทคนิค ____',
        accept: ['SOLER', 'โซลเลอร์'],
      ...
      {
        id: 'f6-04',
        q: 'เทคนิคการทวนความว่า "ที่คุณหมายความว่า... ใช่ไหมครับ?" เรียกว่า ____',
        accept: ['Paraphrasing', 'Paraphrase', 'การทวนความ'],
        hint: 'คำภาษาอังกฤษขึ้นต้นด้วย P',
        explain: 'Paraphrasing ช่วยยืนยันความเข้าใจและทำให้ลูกค้ารู้สึกว่าถูกรับฟัง',
        ref: 'บทที่ 6 — Active Listening'
      },
      {
        id: 'f6-05',
        q: 'Empathy ระดับสูงสุดที่ลงมือช่วยแก้ปัญหาให้ลูกค้า เรียกว่า ____ Empathy',
        accept: ['Compassionate', 'คอมแพสชันเนต'],
        hint: 'คำภาษาอังกฤษขึ้นต้นด้วย C',
        explain: '3 ระดับ: Cognitive → Emotional → Compassionate (สูงสุด — ลงมือช่วยแก้ปัญหา)',
        ref: 'บทที่ 6 — Empathy'
      },
      {
        id: 'f6-06',
        q: 'ทางเลือกสำรองที่ดีที่สุดหากการเจรจาไม่สำเร็จ ซึ่งผู้ที่รู้ของตัวเองดีกว่าจะมีอำนาจต่อรองสูงกว่า เรียกย่อว่า ____',
        accept: ['BATNA'],
        hint: 'ตัวย่อ 5 ตัวอักษร',
        explain: 'BATNA = Best Alternative To a Negotiated Agreement',
        ref: 'บทที่ 6 — Negotiation'
      },
      {
        id: 'f6-07',
        q: 'เทคนิคการเจรจาที่เสนอราคาแรกก่อนเสมอ เพราะตัวเลขแรกจะเป็น "สมอ" ในใจลูกค้า เรียกว่า ____',
        accept: ['Anchoring', 'Anchor', 'แองเคอริ่ง'],
        hint: 'คำภาษาอังกฤษที่มาจากคำว่า "สมอเรือ"',
        explain: 'Anchoring — ตัวเลขแรกที่เสนอจะกลายเป็นจุดอ้างอิงในใจลูกค้า',
        ref: 'บทที่ 6 — Negotiation'
      },
      {
        id: 'f6-08',
        q: 'แทนที่จะลดราคา ให้เพิ่มคุณค่า เช่น บริการหลังการขายหรือการรับประกัน เรียกว่าเทคนิค ____',
        accept: ['Bundling', 'Bundle', 'บันเดิล'],
        hint: 'คำภาษาอังกฤษขึ้นต้นด้วย B',
        explain: 'Bundling รักษา Margin ไว้ได้โดยที่ลูกค้ายังรู้สึกว่าได้เพิ่ม',
        ref: 'บทที่ 6 — Negotiation'
      },
      {
        id: 'f6-09',
        q: 'กระบวนการ Problem Solving ในการขาย 4 ขั้นคือ Define → ____ → Design → Deliver',
        accept: ['Diagnose', 'ไดแอกโนส'],
        hint: 'ขั้นวิเคราะห์สาเหตุรากเหง้า (Root Cause)',
        explain: 'Define → Diagnose (วิเคราะห์ Root Cause) → Design → Deliver',
        ref: 'บทที่ 6 — Problem Solving'
      },
      {
        id: 'f6-10',
        q: 'กฎ ____ (Pareto) ระบุว่าลูกค้า 20% สร้างรายได้ 80% จึงควรโฟกัส High-Value Customers ก่อน',
        accept: ['80/20', '80-20', '8020', '80:20'],
        hint: 'ตัวเลข 2 จำนวนคั่นด้วยเครื่องหมาย /',
        explain: 'กฎ 80/20 หรือ Pareto Principle',
        ref: 'บทที่ 6 — Time Management'
      },
      {
        id: 'f6-11',
        q: 'ตามโมเดลของ Daniel Goleman ทักษะที่สำคัญกว่า IQ ถึง 2 เท่าในการทำนายความสำเร็จในอาชีพคือ ____',
        accept: ['EQ', 'Emotional Intelligence', 'อีคิว', 'ความฉลาดทางอารมณ์'],
        hint: 'ตัวย่อ 2 ตัวอักษร',
        explain: 'EQ (Emotional Intelligence) สำคัญกว่า IQ ถึง 2 เท่า',
        ref: 'บทที่ 6 — Emotional Intelligence'
      },
      {
        id: 'f6-12',
        q: 'กรอบแนวคิด Fixed Mindset vs Growth Mindset เป็นผลงานของ Carol ____',
        accept: ['Dweck', 'ดเว็ก', 'ดเวค'],
        hint: 'นามสกุลขึ้นต้นด้วย D',
        explain: 'Carol Dweck\'s Framework — Fixed Mindset vs Growth Mindset',
        ref: 'บทที่ 6 — Growth Mindset'
      },
      {
        id: 'f6-13',
        q: 'การยืนท่า Wonder Woman 2 นาทีก่อนนำเสนอเพื่อลด Cortisol 25% และเพิ่ม Testosterone 20% เรียกว่า ____ Pose',
        accept: ['Power', 'พาวเวอร์'],
        hint: 'คำภาษาอังกฤษ 5 ตัวอักษร แปลว่า "พลัง"',
        explain: 'Power Pose (Amy Cuddy)',
        ref: 'บทที่ 6 — Confidence'
      },
      {
        id: 'f6-14',
        q: 'นักขายที่ดีควรพูด 30% และ ____ 70%',
        accept: ['ฟัง', 'ฟังลูกค้า', 'Listen'],
        hint: 'คำกริยาไทย 2 ตัวอักษร',
        explain: 'พูด 30% ฟัง 70% — ลูกค้าที่พูดมากกว่าคือลูกค้าที่กำลัง Engage',
        ref: 'บทที่ 6 — Common Mistakes'
      }
    ],
    ...
    matchSets: [
      {
        id: 's6-01',
        title: 'เทคนิค SOLER ในการฟังอย่างตั้งใจ',
        items: [
          { q: 'หันหน้าเข้าหาลูกค้าโดยตรง = ____', answer: 'Squarely face' },
          { q: 'ท่าทางเปิดรับ ไม่กอดอก = ____', answer: 'Open posture' },
          { q: 'โน้มตัวเล็กน้อยแสดงความสนใจ = ____', answer: 'Lean in' },
          { q: 'สบตาสม่ำเสมอ ไม่จ้องจนน่ากลัว = ____', answer: 'Eye contact' },
          { q: 'ผ่อนคลาย ไม่เกร็ง = ____', answer: 'Relax' }
        ],
        ref: 'บทที่ 6 — Active Listening'
      },
      {
        id: 's6-02',
        title: '4 เทคนิคการเจรจาต่อรอง',
        items: [
          { q: 'เสนอราคาแรกก่อนเสมอ ตัวเลขแรกเป็น "สมอ" ในใจลูกค้า = ____', answer: 'Anchoring' },
          { q: 'หลังเสนอราคาแล้วหยุดพูด รอให้ลูกค้าตอบก่อน = ____', answer: 'Silence is Power' },
          { q: 'แทนที่จะลดราคา ให้เพิ่มคุณค่าเช่นการรับประกัน = ____', answer: 'Bundling' },
          { q: '"ถ้าคุณสั่ง 100 ชิ้น ผมให้ส่วนลด 15% ได้" = ____', answer: 'If-Then' },
          { q: 'ทางเลือกสำรองที่ดีที่สุดหากเจรจาไม่สำเร็จ = ____', answer: 'BATNA' }
        ],
        ref: 'บทที่ 6 — Negotiation'
      },
      {
        id: 's6-03',
        title: '5 องค์ประกอบของ EQ ในการขาย (Goleman)',
        items: [
          { q: 'รู้จักอารมณ์ตัวเอง รู้ว่าตัวเองเครียดก่อนแสดงออก = ____', answer: 'Self-Awareness' },
          { q: 'ควบคุมอารมณ์ ไม่โกรธเมื่อลูกค้าต่อว่า = ____', answer: 'Self-Regulation' },
          { q: 'แรงขับภายใน ขายเพราะอยากช่วยลูกค้า ไม่ใช่แค่ Commission = ____', answer: 'Motivation' },
          { q: 'อ่านอารมณ์ลูกค้าได้ รู้ว่าเมื่อไรควรหยุดพูด = ____', answer: 'Empathy' },
          { q: 'สร้างความสัมพันธ์ระยะยาวจนลูกค้ากลายเป็นเพื่อน = ____', answer: 'Social Skills' }
        ],
        ref: 'บทที่ 6 — Emotional Intelligence'
      },
      {
        id: 's6-04',
        title: 'กรอบ SPIN Selling และ FAB',
        items: [
          { q: '"ปัจจุบันคุณใช้ระบบอะไรอยู่?" เก็บข้อมูลพื้นฐาน = ____', answer: 'Situation' },
          { q: '"มีปัญหาอะไรกับระบบเดิมบ้าง?" ค้นหาจุดเจ็บปวด = ____', answer: 'Problem' },
          { q: '"ปัญหานี้ส่งผลต่อยอดขายอย่างไร?" ขยายผลกระทบ = ____', answer: 'Implication' },
          { q: '"ถ้าแก้ปัญหานี้ได้ คุณจะประหยัดได้เท่าไหร่?" สร้างคุณค่า = ____', answer: 'Need-Payoff' },
          { q: '"แบตเตอรี่ 5,000 mAh" — สินค้ามีอะไร = ____', answer: 'Feature' }
        ],
        ref: 'บทที่ 6 — Critical Thinking & Communication'
      },
      {
        id: 's6-05',
        title: 'Sales Activity Matrix และการบริหารเวลา',
        items: [
          { q: 'ติดตามดีลที่ใกล้ปิด (Urgent + Important) → ____', answer: 'ทำทันที' },
          { q: 'Prospecting และพัฒนาทักษะ (Not Urgent + Important) → ____', answer: 'วางแผนทำ' },
          { q: 'ตอบ Email ทั่วไป (Urgent + Not Important) → ____', answer: 'มอบหมายหรือทำเร็ว ๆ' },
          { q: 'Social Media ไม่เกี่ยวงาน (Not Urgent + Not Important) → ____', answer: 'ตัดออก' },
          { q: 'ลูกค้า 20% สร้างรายได้ 80% คือกฎ ____', answer: '80/20 (Pareto)' }
        ],
        ref: 'บทที่ 6 — Time Management'
      }
    ]
